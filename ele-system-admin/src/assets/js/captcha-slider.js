...
var CaptchaSlider = {
  ...
  initCanvas: function initCanvas() {
    ...
    imgElement.src = 'http://t7giez8zm.hb-bkt.clouddn.com/captcha-slider/canvas%28' + creatRandomBy(1, 1) + '%29.jpg?imageView2/1/w/' + _this.param.width + '/h/' + _this.param.height + '/q/75|imageslim';
